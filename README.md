<p align="center">
  <img src="assets/banner.png" alt="Grimoire — a spellbook of AI skills, free to steal" width="700">
</p>
...
```
assets/generate_art.py            regenerates the logo and banner at any scale
...
<img src="assets/logo.png" alt="Grimoire logo" width="96" align="left">

The logo and banner are pixel art, generated by `assets/generate_art.py` — pure standard
library, no Pillow and no build step. The art is defined as code rather than hand-placed
rectangles, so it can be redrawn at any scale without anyone repainting it.

```
python3 assets/generate_art.py             # write the PNG and SVG files
python3 assets/generate_art.py --preview   # draw it in the terminal instead
```

<br clear="left">

The logo ships as both PNG and SVG; the banner as PNG only, because an SVG starfield
costs about 130 KB of rectangles for nothing the 3x PNG does not already give you.

## License

MIT. Free to steal, as advertised. The artwork too.
